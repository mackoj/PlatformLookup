...
extension PlatformLookup {
  ...
  /// - Parameter deviceFilter: <#deviceFilter description#>
  static public func findAllDevicesForAnOSVersion(_ deviceFamily : DeviceFamily, version : String? = nil) -> [Platform] {
    return PlatformLookup.shared?.getAllDevices(with: filterDeviceFamily(deviceFamily), runtimeFilter: filterRuntime(deviceFamily.os, version: version)) ?? []
  }

  /// Trouve tous les devices pour une version d'os
  /// - Parameter deviceFilter: <#deviceFilter description#>
  static public func findAllDevicesForAnOSVersion(deviceName : String, version : String? = nil) -> [Platform] {
  ...
  private func getAllDevices(with deviceFilter : DeviceFilter, runtimeFilter: RuntimeFilter) -> [Platform] {
